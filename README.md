...
* [`nn.ipynb`](nn.ipynb): classification with a multi-output neural network. The model is trained on the ResNet50 bottleneck features. The F1 score is calculated on the test dataset: *0.83160*
